...
public class AssetRepository {
	...
	public List<Asset> findForCriteria(SearchAsset searchAsset) {
		List<Object> preparedStatementValues = new ArrayList<Object>();
		String queryStr = assetQueryBuilder.getQuery(searchAsset, preparedStatementValues);
		List<Asset> assets = jdbcTemplate.query(queryStr, 
				preparedStatementValues.toArray(), assetRowMapper);
		return assets;
	}
}